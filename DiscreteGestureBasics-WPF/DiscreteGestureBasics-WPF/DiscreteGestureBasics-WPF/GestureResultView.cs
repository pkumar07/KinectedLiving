...
namespace Microsoft.Samples.Kinect.DiscreteGestureBasics
{
    ...
    public sealed class GestureResultView : INotifyPropertyChanged
    {
        ...
        private readonly ImageSource leftImage = new BitmapImage(new Uri(@"Images\leftpic.png", UriKind.Relative));
        private readonly ImageSource rightImage = new BitmapImage(new Uri(@"Images\rightpic.jpg", UriKind.Relative));
        private readonly ImageSource clapImage = new BitmapImage(new Uri(@"Images\clappic.png", UriKind.Relative));
        private readonly ImageSource nogesture = new BitmapImage(new Uri(@"Images\nogesture.png", UriKind.Relative));
        ...
        private Brush bodyColor = Brushes.ForestGreen;
        ...
        public void UpdateGestureResult(bool isBodyTrackingIdValid, bool isGestureDetected, float detectionConfidence, string gestureName)
        {
            ...
            else
            {
                ...
                if (gestureName.Equals("ledON_Left"))
                {
                    this.Confidence = detectionConfidence;
                    this.ImageSource = this.leftImage;
                }
                else if (gestureName.Equals("ledON_Right"))
                {
                    this.Confidence = detectionConfidence;
                    this.ImageSource = this.rightImage;
                }
                else if (gestureName.Equals("All_ledOFF"))
                {
                    this.Confidence = detectionConfidence;
                    this.ImageSource = this.clapImage;
                }
                else
                {
